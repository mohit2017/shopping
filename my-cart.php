...
<form name="cart" method="post" action="pgRedirect.php">	
<?php
if(!empty($_SESSION['cart'])){
	?>
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<tbody>
				<tr>
					<td>
						<input type="text" id="ORDER_ID" name="ORDER_ID" value="<?php echo  "ORDS" . rand(10000,99999999)?>">
					</td>
				</tr>
				<tr>
					<td>
						<input type="text" id="CUST_ID" name="CUST_ID" value="CUST001"></td>
				</tr>
				<tr>
					<td><input type="text" id="INDUSTRY_TYPE_ID" name="INDUSTRY_TYPE_ID" value="Retail"></td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<input title="TXN_AMOUNT" type="text" name="TXN_AMOUNT" value="1">
					</td>
				</tr>
				<!-- <tr>
					<td></td>
